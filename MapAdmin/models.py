...
class Punto(models.Model):
    ...
    def __str__(self):
        return str(self.lat)+','+str(self.lon)+'('+str(self.id)+')'
# Linea constituida de puntos para hacer de camino (este es visual)
...
class Edificacion(models.Model):
    ...
    informacion = models.TextField(max_length=3000,null=True)
...
# Puntos de entrada de las edificaciones
